...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)), "#777E76"),
            -- wibox.container.background(wibox.container.margin(task, dpi(3), dpi(7)), "#343434"),
            arrow("#777E76", "#343434"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), (3)), "#343434"),
            arrow("#343434", "#4B696D"),
